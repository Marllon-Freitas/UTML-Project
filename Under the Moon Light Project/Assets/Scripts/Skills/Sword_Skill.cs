...
public class Sword_Skill : Skill
{
    ...
    {
        Vector2 position = (Vector2)player.transform.position + new Vector2(AimDirection().normalized.x * launchForce.x, AimDirection().normalized.y * launchForce.y) * t + (t * t) * 0.5f * (Physics2D.gravity * swordGravity);
        return position;
    }
    #endregion
}